...
\usepackage{pmmeta}
\pmcanonicalname{PlanetMathCommunityGuidelinesSecondDraftVersion}
\pmcreated{2013-03-11 19:34:31}
\pmmodified{2013-03-11 19:34:31}
\pmowner{rspuzio}{6075}
\pmmodifier{}{0}
\pmtitle{PlanetMath Community Guidelines -- Second Draft Version}
\pmrecord{1}{50125}
\pmprivacy{1}
\pmauthor{rspuzio}{0}
\pmtype{Definition}
...
\title{Code of Conduct on the PM community - Draft Version}
...
\item Abuse of the entry rating system may be subject to rating reset (meaning erasure of all previous ratings of the entry in question), as well as possibly points being deducted from offending raters.  Abusive behavior includes (but not limited to) consistently giving a high rating to an entry simply because the author is your friend, giving a low rating to an entry simply because you don't like the author, or any of the behavior stated in item 4.1.
\end{enumerate}
...
points of both proposals but is not open the objections which were
raised.
...
about your making your proposal happen and therefore may serve to
...
noone else has an obligation to collaborate with you since
...
effort some towards a project to make known objections which would
